import 'package:bloc_structure/bloc_app/features/user_list/cubit/user_list_cubit.dart';
import 'package:bloc_structure/bloc_app/features/user_list/cubit/user_list_state.dart';
      ...
      child: BlocConsumer<UserListCubit, UserListState>(
        builder: (context, state) {
          return state.maybeWhen(null,
              initial: () => _initialContainerWidget(context),
              orElse: () => _initialContainerWidget(context));
        },
